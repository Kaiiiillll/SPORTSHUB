...
if (isset($_POST["btnAddUser"])) {
    ...
    $iusr = mysqli_query($conn, "INSERT INTO users (usrMatricID, usrName, usrEmail, usrPhone, usrFac, usrCourse) VALUES ('$usrMatricID', '$usrName', '$usrEmail', '$usrPhone', '$usrFac', '$usrCourse')");
