	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav" class="p-t-30">
				...
				<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="tools.php" aria-expanded="false"><i class="mdi mdi-tooltip"></i><span class="hide-menu">Equipments</span></a></li>
