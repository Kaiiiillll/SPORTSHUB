...
<head>
    ...
    <!-- Favicon icon -->
     <link rel="icon" type="image/png" sizes="16x16" href="assets/images/ctulogo.png">
                                ...
                                <form method="POST">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input class="form-control" type="text" name="usrMatricID" placeholder="Student ID" required />
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Name :</label>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="select2 form-control custom-select" name="usrFac" style="width: 100%; height:36px;">
                                                <option value="FST">Department of Engineering</option>
                                                <option value="FPQS">Department of Education</option>
                                                <option value="FKP">Department of Technology</option>
                                                <option value="FSU">Department of </option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Course :</label>
